            ...
            if (
              "next" === t
                ...
                : (n = "carousel-item-right",
                  ...
                  a = "right"), u && o.default(u).hasClass("active")
            ) {
              this._isSliding = !1;
            } else if (
              !this._triggerSlideEvent(u, a).isDefaultPrevented() && l && u
            ) {
              this._isSliding = !0,
                c && this.pause(),
                this._setActiveIndicatorElement(u);
              var h = o.default.Event(
                "slid.bs.carousel",
      ...
      D = function () {
        function t(t, e) {
          ...
          for (
            ...
            var a = n[i],
              ...
              l = [].slice.call(document.querySelectorAll(s)).filter(
                (function (e) {
                  return e === t;
                }),
              );
        ...
        return e.toggle = function () {
          ...
          e.show = function () {
            ...
            if (
              ...
              if (
                ...
                o.default(this._element).removeClass("collapse").addClass(
                  "collapsing",
                ),
                  this._element.style[s] = 0,
                  this._triggerArray.length &&
                  o.default(this._triggerArray).removeClass("collapsed").attr(
                    "aria-expanded",
                    !0,
                  ),
            ...
            if (
              ...
              if (
                ...
                this._element.style[n] =
                  ...
                  o.default(this._element).addClass("collapsing").removeClass(
                    "collapse show",
                  );
                  ...
                  for (var a = 0; a < i; a++) {
                    ...
                    if (
                      ...
                      o.default([].slice.call(document.querySelectorAll(l)))
                        .hasClass("show") ||
                        o.default(s).addClass("collapsed").attr(
                          "aria-expanded",
                          !1,
                        );
                    }
                ...
                o.default(this._element).one(
                  ...
                  (function () {
                    t.setTransitioning(!1),
                      o.default(t._element).removeClass("collapsing").addClass(
                        "collapse",
          ...
          e._getDimension = function () {
            return o.default(this._element).hasClass("width") ? "width"
            : "height";
          },
          e._getParent = function () {
            ...
            var i = '[data-toggle="collapse"][data-parent="' +
                this._config.parent + '"]',
              a = [].slice.call(e.querySelectorAll(i));
            return o.default(a).each(
              (function (e, i) {
          ...
          e._addAriaAndCollapsedClass = function (t, e) {
            ...
            e.length &&
              o.default(e).toggleClass("collapsed", !n).attr(
                "aria-expanded",
                n,
              );
          },
          ...
          t._jQueryInterface = function (e) {
            return this.each(
              (function () {
                ...
                if (
                  !i && a.toggle && "string" == typeof e &&
                  /show|hide/.test(e) && (a.toggle = !1),
      ...
      x = function () {
        ...
        return e.toggle = function () {
          ...
          e.show = function (e) {
            if (
              ...
              if (o.default(s).trigger(i), !i.isDefaultPrevented()) {
                ...
                o.default(document.body).children().on(
                  "mouseover",
                  null,
                  o.default.noop,
                ),
                  ...
                  o.default(s).toggleClass("show").trigger(
            ...
            if (
              ...
              o.default(i).trigger(n),
                ...
                (this._popper && this._popper.destroy(),
                  o.default(this._menu).toggleClass("show"),
                  o.default(i).toggleClass("show").trigger(
                ...
                if (e && "click" === e.type && (r.clickEvent = e), l) {
                  ...
                  if (
                    ...
                    o.default(s).trigger(d),
                      ...
                      ("ontouchstart" in document.documentElement &&
                        o.default(document.body).children().off(
                          "mouseover",
                          null,
                          o.default.noop,
                        ),
                        ...
                        o.default(s).removeClass("show").trigger(
          ...
          t._dataApiKeydownHandler = function (e) {
            if (
              !(/input|textarea/i.test(e.target.tagName) ? 32 === e.which ||
                27 !== e.which &&
              ...
              if (i || 27 !== e.which) {
                if (
                  ...
                  return 27 === e.which &&
                    o.default(n.querySelector('[data-toggle="dropdown"]'))
                      .trigger("focus"),
        ...
        return e.toggle = function (t) {
          ...
          e._showElement = function (t) {
            var e = this,
              ...
              i = this._dialog ? this._dialog.querySelector(".modal-body")
              : null;
            ...
            if (n) {
              ...
              o.default(this._dialog).one(d.TRANSITION_END, s)
          ...
          e._enforceFocus = function () {
            var t = this;
            o.default(document).off("focusin.bs.modal").on(
              "focusin.bs.modal",
              (function (e) {
          ...
          e._setEscapeEvent = function () {
            var t = this;
            this._isShown ? o.default(this._element).on(
          ...
          e._setResizeEvent = function () {
            var t = this;
            this._isShown ? o.default(window).on(
              "resize.bs.modal",
              (function (e) {
          ...
          e._showBackdrop = function (t) {
            ...
            if (this._isShown && this._config.backdrop) {
              ...
              o.default(this._backdrop).one(d.TRANSITION_END, t)
                .emulateTransitionEnd(i);
              ...
              if (o.default(this._element).hasClass("fade")) {
                ...
                o.default(this._backdrop).one(d.TRANSITION_END, a)
            ...
            if (this._isBodyOverflowing) {
              ...
              o.default(e).each(
                (function (e, n) {
                  ...
                  o.default(n).data("padding-right", i).css(
                    "padding-right",
                ...
                o.default(n).each(
                  (function (e, n) {
                    ...
                    o.default(n).data("margin-right", i).css(
                      "margin-right",
                      parseFloat(a) - t._scrollbarWidth + "px",
                    );
                  }),
              ...
              o.default(document.body).data("padding-right", i).css(
                "padding-right",
          ...
          e._resetScrollbar = function () {
            ...
            o.default(e).each(
              (function (t, e) {
                ...
                "undefined" != typeof n &&
                  o.default(e).css("margin-right", n).removeData(
                    "margin-right",
                  );
              }),
            );
          ...
          t._jQueryInterface = function (e, n) {
            return this.each(
              (function () {
                ...
                if (
                  i ||
                  (i = new t(this, a), o.default(this).data("bs.modal", i)),
                    "string" == typeof e
                ) {
                  if ("undefined" == typeof i[e]) {
                    throw new TypeError('No method named "' + e + '"');
        ...
        return e.enable = function () {
          ...
          e.dispose = function () {
            clearTimeout(this._timeout),
              ...
              o.default(this.element).closest(".modal").off(
                "hide.bs.modal",
          ...
          e.show = function () {
            var t = this;
            if (
              "none" === o.default(this.element).css("display")
            ) {
            ...
            if (this.isWithContent() && this._isEnabled) {
              ...
              o.default(s).data(this.constructor.DATA_KEY, this),
                ...
                o.default(this.element).trigger(
              ...
              if (o.default(this.tip).hasClass("fade")) {
                ...
                o.default(this.tip).one(d.TRANSITION_END, c)
          ...
          e._setListeners = function () {
            ...
            this.config.trigger.split(" ").forEach(
              ...
              o.default(this.element).closest(".modal").on(
                "hide.bs.modal",
                this._hideModalHandler,
              ),
      ...
      ut = function () {
        function t(t, e) {
          ...
          this._element = t,
            ...
            o.default(this._scrollElement).on(
              "scroll.bs.scrollspy",
              (function (t) {
                return n._process(t);
              }),
        ...
        return e.refresh = function () {
          ...
          e._activate = function (t) {
            ...
            var e = this._selector.split(",").map(
                (function (e) {
            ...
            n.hasClass("dropdown-item")
              ? (n.closest(".dropdown").find(".dropdown-toggle").addClass(
                "active",
              ),
                n.addClass("active"))
              : (n.addClass("active"),
                n.parents(".nav, .list-group").prev(
                  ".nav-link, .list-group-item",
                ).addClass("active"),
                n.parents(".nav, .list-group").prev(".nav-item").children(
                  ".nav-link",
                ).addClass("active")),
              o.default(this._scrollElement).trigger(
        ...
        return e.show = function () {
          ...
          e._activate = function (t, e, n) {
            ...
            if (a && s) {
              ...
              o.default(a).removeClass("show").one(d.TRANSITION_END, l)
                .emulateTransitionEnd(r);
            }
            elsel();
          },
          e._transitionComplete = function (t, e, n) {
            if (e) {
              o.default(e).removeClass("active");
              var i =
                o.default(e.parentNode).find("> .dropdown-menu .active")[0];
        ...
        return e.show = function () {
          ...
          if (o.default(this._element).trigger(e), !e.isDefaultPrevented()) {
            ...
            if (
              ...
              o.default(this._element).one(d.TRANSITION_END, n)
                .emulateTransitionEnd(i);
            } else n();
          }
        },
          ...
          e._close = function () {
            ...
            if (
              ...
              o.default(this._element).one(d.TRANSITION_END, e)
                .emulateTransitionEnd(n);
            }
            elsee();
          },
              ...
              (function () {
                ...
                if (
                  ...
                  (i = new t(this, "object" == typeof e && e),
                    n.data("bs.toast", i)), "string" == typeof e
                ) {
                  if ("undefined" == typeof i[e]) {
                    throw new TypeError(
                      'No method named "' + e + '"',
